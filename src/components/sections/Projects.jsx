  ...
  const projects = [
    {
      ...
      description:
        "A comprehensive educational management system featuring real-time collaboration, progress tracking, and analytics dashboard. Built with modern technologies for optimal performance and user experience.",
    ...
    {
      title: "Medical Health EDA",
      description:
        "An exploratory data analysis project that examines medical health datasets to identify patterns in patient conditions, risk factors, and treatment outcomes. The analysis includes data cleaning, visualization, and statistical insights to support better healthcare decision-making.",
      tech: [
        "Python",
        "Pandas",
        "NumPy",
    ...
    },
    {
      ...
      description:
        "A web-based doctor appointment booking system that allows patients to schedule appointments with doctors easily. The platform includes features like selecting available time slots, managing bookings, and a simple interface for viewing upcoming appointments.",
      tech: ["React", "Tailwind CSS"],
      category: "Front-End Web Application",
      status: "Live",
      gradient: "from-blue-500 to-green-500",
      link: "https://github.com/hamzafaisalgit/Doctor-Appointment-System",
    },
    {
      title: "Vibe-Beat",
      description:
        "A simple, Spotify-inspired music player built using HTML, CSS, and JavaScript, with a list of multiple tracks and updated features.",
    ...
    },
    {
      ...
      description:
        "Modern, responsive portfolio website showcasing advanced CSS animations, smooth transitions, and optimized performance. Built with accessibility and SEO best practices in mind.",
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 text-lg font-light max-w-2xl mx-auto">
            A selection of projects that demonstrate my expertise in modern web
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <div key={index} className="group relative">
              <div
                className={`absolute -inset-1 bg-gradient-to-r ${project.gradient} rounded-lg blur opacity-20 group-hover:opacity-40 transition-opacity duration-300`}
              ></div>
